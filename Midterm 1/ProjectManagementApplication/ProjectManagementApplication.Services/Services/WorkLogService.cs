...
namespace ProjectManagementApplication.Services.Services
{
    public class WorkLogService : IWorkLogService
    {
        ...
        public async Task<Tuple<Messages, int>> CreateWorkLog(int taskId, string description, TimeSpan timeSpent, DateTime startDate, int userId)
        {
        ...
        public async Task<bool> DeleteWorkLog(int workLogId, int taskId, int userId)
        {
            return await _workLogRepository.Delete(workLogId, taskId, userId);
        }

        public async Task<bool> EditWorkLog(int workLogId, string description, int taskId, DateTime startDate, TimeSpan timeSpent, int userId)
        {
        ...
        public async Task<List<WorkLog>> GetAllWorkLogs(int taskId, int userId)
        {
            return await _workLogRepository.GetAll(taskId, userId);
        }
