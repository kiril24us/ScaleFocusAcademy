    ...
    public class IdentityConfig
    {
        public static IEnumerable<Client> Clients =>
            new List<Client>
            {
                new Client
                {
                    ClientId = "ProjectManagementApplication",
                    ...
                    AllowedScopes = { "users", "offline_access", "ProjectManagementApplication", "roles" }
                }
            };
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new List<ApiScope>
            {
                    ...
                    new ApiScope("ProjectManagementApplication", "app")
            };
    }
}
