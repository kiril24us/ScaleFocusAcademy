...
namespace ProjectManagementApplication.Services.Services
{
    public class ProjectService : IProjectService
    {
        ...
        public async Task<Tuple<Messages,int>> CreateProject(string name, string userId)
        {
        ...
        public async Task<bool> EditProject(int projectId, string name, string userId)
        {
        ...
        public async Task<Messages> AssignProject(int projectId, int teamId, string userId)
        {
        ...
        {
            return await _projectRepository.GetMineProjects(userId);
        }
    }
}
